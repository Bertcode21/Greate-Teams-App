Greate-teams-app is a software as a service(SaaS) project. this is web-application built with angular, prima, postgreSQl and nestjs this software is used for managing teams across different platforms
...
makes the organizational flow easy
